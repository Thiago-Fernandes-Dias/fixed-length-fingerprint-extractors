...
FOLDERS = [
    (
        "/mnt/d/Datasets/FVC/FVC2000/Dbs/Db1_a/tif",
        "../results/FLARE_ENH/fvc_2000_db1_a.csv",
        A_SUBJECTS,
    ),
    (
        "/mnt/d/Datasets/FVC/FVC2004/Dbs/Db1_a/tif",
        "../results/FLARE_ENH/fvc_2004_db1_a.csv",
        A_SUBJECTS,
    ),
]
...
def main():
    ...
    logging.info(
        "Initializing FLARE Pipeline with Fingerprint Enhancement (UNetEnh)..."
    )
    pipeline = FLAREFullPipeline(
